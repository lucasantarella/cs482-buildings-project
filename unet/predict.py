...
os.chdir('/home/jovyan/work/unet/weights/')
weights_path = '/home/jovyan/work/unet/weights/' +  (str(subprocess.getoutput("ls -ltd * | awk '{print $9}' | head -n 1")) 
...
if __name__ == '__main__':
    ...
    test_id = sys.argv[2]
    img = tiff.imread('data/test/PS-RGB/{}'.format(test_id))
    
    plt.imshow(img)
    plt.show()
    img = normalize(tiff.imread('data/test/PS-RGB/{}'.format(test_id)))
    for i in range(7):
    ...
    tiff.imsave('/home/jovyan/work/output/result.tif', (255*mymat).astype('uint8'))
    tiff.imsave('/home/jovyan/work/output/map.tif', map)
